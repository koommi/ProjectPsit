...
data = Data([
    Scattergeo(
        ...
        lonsrc='beobonus:242:564217',
        text=['Brunei(10,459)', 'Cambodia(423,642)', 'Indonesia(447,820)', 'Lao( 975,999)', 'Malaysia(2,554,397)', 'Myanmar(129,385)', 'Philippines(289,566)', 'Singapore(831,215)', 'Vietnam(618,670)', 'China(2,786,860)', 'Hong Kong(473,666)', 'Japan(1,373,716)', 'Korea(1,163,619)', 'Taiwan(394,225)', 'Austria(94,667)', 'Belgium(94,896)', 'Denmark(167,499)', 'Finland(154,919)', 'France(576,106)', 'Germany(682,419)', 'Ireland(60,305)', 'Italy(200,703)', 'Netherlands(208,122)', 'Norway(148,796)', 'Russia(1,316,564)', 'Spain(113,141)', 'Sweden(364,681)', 'Switzerland(191,147)', 'United Kingdom(873,053)', 'Argentina(17,853)', 'Brazil(30,387)', 'Canada(219,354)', 'USA(768,638)', 'Bangladesh(72,657)', 'India(1,013,308)', 'Nepal(26,277)', 'Pakistan(71,982)', 'Sri Lanka(73,346)', 'Australia(930,241)', 'New Zealand(113,871)', 'Egypt(19,918)', 'Israel(129,551)', 'Kuwait(64,611)', 'Saudi Arabia(17,084)', 'Emirates(113,547)', 'South Africa(76,326)'],
        textsrc='beobonus:158:3dbf7e',
        uid='58ed3b'
    )
])
layout = Layout(
